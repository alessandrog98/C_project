 ...
 * ruota l'immagine (ip_mat) del valore (degree) inserito
 * valori degree possibili = 0,90,270,360
 * con degree 0 effettua specchiatura dell'immagine
 * con degree 360 effettua copia dell'immagine di partenza
 * con degree 90 e 270 non è possibile effettuare poi la concat con l'immagine in input
 * */
